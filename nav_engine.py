...
ETF_BASKET = [
    {"ticker": "US2Y",  "label": "US 2Y Treasury",   "face": 1_000_000, "coupon": 0.0456, "maturity_years": 2.0,  "weight": 0.18},
    {"ticker": "US5Y",  "label": "US 5Y Treasury",   "face": 1_000_000, "coupon": 0.0425, "maturity_years": 5.0,  "weight": 0.22},
    {"ticker": "US10Y", "label": "US 10Y Treasury",  "face": 1_000_000, "coupon": 0.0438, "maturity_years": 10.0, "weight": 0.25},
    {"ticker": "US30Y", "label": "US 30Y Treasury",  "face": 1_000_000, "coupon": 0.0450, "maturity_years": 30.0, "weight": 0.15},
    {"ticker": "IG_A",  "label": "IG Corp A-rated",  "face": 1_000_000, "coupon": 0.0520, "maturity_years": 7.0,  "weight": 0.12},
    {"ticker": "IG_BBB","label": "IG Corp BBB-rated","face": 1_000_000, "coupon": 0.0580, "maturity_years": 5.0,  "weight": 0.08},
]
...
def compute_nav(yields_df: pd.DataFrame) -> dict:
    ...
    nav_per_share = total_portfolio_value / TOTAL_SHARES * 1_000_000
...
def fetch_etf_market_price(etf_ticker: str = "AGG", lookback_days: int = 30) -> pd.Series:
    """
    Fetch market close prices for the ETF (used to compute premium/discount to NAV).
    Uses AGG (iShares Core US Aggregate Bond ETF) as the reference ETF.
    """
    end = datetime.today()
    start = end - timedelta(days=lookback_days)
